...
export const CarTable = pgTable("car", {
    ...
    location_id: serial("location_id").notNull().references(() => LocationTable.location_id, { onDelete: 'set null' }),
...
export const ReservationTable = pgTable("reservation", {
    ...
    customer_id: serial("customer_id").notNull().references(() => CustomerTable.customer_id, { onDelete: 'cascade' }),
    car_id: serial("car_id").notNull().references(() => CarTable.car_id, { onDelete: 'cascade' }),
...
export const PaymentTable = pgTable("payment", {
    ...
    booking_id: serial("booking_id").notNull().references(() => BookingTable.booking_id, { onDelete: 'cascade' }),
